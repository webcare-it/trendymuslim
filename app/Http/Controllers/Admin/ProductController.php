...
class ProductController extends Controller
{
    ...
    public function droplooProductList()
    {
        ...
        $appKey = $generalSetting->droploo_app_key ?? 'G7MHPT6MMLYI0NBG';
        $appSecret = $generalSetting->droploo_app_secret ?? 't06ELYyxJwGxXeNyKYDi0c9ba9gtmOTr';
        $userName = $generalSetting->droploo_username ?? 'mohammad-imam_kapramartcom';
        ...
        if ($response->successful()) {
            ...
            $addedProductIds = Product::whereNotNull('b_product_id')
                ->pluck('b_product_id')
                ->toArray();

            return view('admin.products.droploo-product', compact('products', 'imagePath', 'addedProductIds'));
        } else {
