...
Route::group(['prefix' => 'admin'], function(){
    ...
    Route::group(['middleware' => 'isAdmin'], function(){
        ...
        Route::post('/clear-cache', [\App\Http\Controllers\Auth\AdminController::class, 'clearCache'])->name('admin.clear.cache');
    });
});
...
//        Route::get('/complete/{id}', [\App\Http\Controllers\Admin\OrderController::class, 'complete'])->name('order.complete');
    ...
    Route::get('/admin/droploo/api/credentials', [\App\Http\Controllers\Admin\SettingController::class, 'droplooApiCredentials'])->name('admin.droploo.api.credentials');
    Route::post('/admin/droploo/api/credentials/update', [\App\Http\Controllers\Admin\SettingController::class, 'updateDroplooApiCredentials'])->name('admin.droploo.api.credentials.update');
    
    //Website Theme Settings...
    Route::get('/admin/website/theme', [\App\Http\Controllers\Admin\SettingController::class, 'websiteTheme'])->name('admin.website.theme');
    Route::post('/admin/website/theme/update', [\App\Http\Controllers\Admin\SettingController::class, 'updateWebsiteTheme'])->name('admin.website.theme.update');

    //Theme Colors Settings...
    Route::get('/admin/theme/colors', [\App\Http\Controllers\Admin\SettingController::class, 'themeColors'])->name('admin.theme.colors');
    Route::post('/admin/theme/colors/update', [\App\Http\Controllers\Admin\SettingController::class, 'updateThemeColors'])->name('admin.theme.colors.update');
