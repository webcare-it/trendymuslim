...
{{--    </li>--}}
    ...
    <li>
        ...
        <ul>
            ...
            <li>
                <a href="{{ route('admin.droploo.api.credentials') }}">
                    <i class="bx bx-right-arrow-alt"></i>Droploo API Credentials
                </a>
            </li>
            <li>
                <a href="{{ route('admin.theme.colors') }}">
                    <i class="bx bx-right-arrow-alt"></i>Theme Colors
                </a>
            </li>
            <li>
